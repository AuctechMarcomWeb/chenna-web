...

{
    ...
    $econtent='<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <![endif]-->
      ...
      <style type="text/css">
        ...
        @media (max-width: 480px) {
          ...
          #u_content_heading_22 .v-font-size {
            font-size: 12px !important;
          }
          #u_content_heading_22 .v-line-height {
          ...
          #u_content_heading_27 .v-font-size {
            font-size: 15px !important;
          }
          #u_content_heading_29 .v-font-size {
            font-size: 15px !important;
          }
          #u_content_heading_30 .v-font-size {
            font-size: 18px !important;
          }
        }
              ...
              <div class="u-row-container" style="padding: 0px;background-color: transparent">
                <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 650px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                  <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                    ...
                    <!--[if (mso)|(IE)]><td align="center" width="383" style="width: 383px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
                    <div class="u-col u-col-58p92" style="max-width: 320px;min-width: 383px;display: table-cell;vertical-align: top;">
                      <div style="width: 100% !important;">
                        <!--[if (!mso)&(!IE)]><!-->
                        <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                          <!--<![endif]-->
                            ...
                            <tbody>
                              <tr>
                                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; color: #000000; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: arial,helvetica,sans-serif; font-size: 14px;">
                                    <strong>Email&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; iofficialaditi@gmail.com</strong>
                                  </h1>
                    ...
                    <div class="u-col u-col-41p08" style="max-width: 320px;min-width: 267px;display: table-cell;vertical-align: top;">
                      <div style="width: 100% !important;">
                        <!--[if (!mso)&(!IE)]><!-->
                        <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                          <!--<![endif]-->
                            ...
                            <tbody>
                              <tr>
                                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align v-line-height" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 140%;">R71, Nehru Enclave</p>
                                    <p style="font-size: 14px; line-height: 140%;">Viishwas Khand, Gomti Nagar</p>
                                    <p style="font-size: 14px; line-height: 140%;">226016,</p>
                                    <p style="font-size: 14px; line-height: 140%;">Lucknow</p>
                                    <p style="font-size: 14px; line-height: 140%;">Uttar Pradesh</p>
                                  </div>
                            ...
                            <tbody>
                              <tr>
                                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; color: #000000; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: arial,helvetica,sans-serif; font-size: 14px;">
                                    <strong>Email&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; alokmaurya15@gmail.com</strong>
                                  </h1>
                            ...
                            <tbody>
                              <tr>
                                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align v-line-height" style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 140%;">709/12, Shiva Colony</p>
                                    <p style="font-size: 14px; line-height: 140%;">Near Mahila Police station</p>
                                    <p style="font-size: 14px; line-height: 140%;">272001,</p>
                                    <p style="font-size: 14px; line-height: 140%;">Basti,</p>
                                    <p style="font-size: 14px; line-height: 140%;">Uttar Pradesh</p>
                                  </div>
