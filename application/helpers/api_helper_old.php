...
function sendSMS($mobile,$message,$template) {
  ...
  $url = "http://sms.teleosms.com/api/mt/SendSMS?user=abhi241092&password=12345&senderid=SHPMET&channel=Trans&DCS=0&flashsms=0&number=".$mobile."&text=".urlencode($message)."&route=2";
