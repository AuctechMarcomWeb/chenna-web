        ...
        <div class="row">
            <div class="col-12">
                <div class="category-slider-1 arrow-slider wow fadeInUp">
                    ...
                    <?php
                    // 🔹 Saari Parent Categories lao
                    $this->db->select('id, name');
                    $parentList = $this->db->get_where(
                        'parent_category_master',
                        ['status' => '1']
                    )->result_array();

                    foreach ($parentList as $parent) {

                        // 🔹 Us parent ki categories
                        $this->db->select('category_name,id,app_icon');
                        $cateList = $this->db->get_where(
                            'category_master',
                            [
                                'mai_id' => $parent['id'],
                                'status' => '1'
                ...
                <div class="product-bg-image wow fadeInUp">
                    ...
                    <div class="product-box-4 product-box-3 rounded-0">
                        ...
                        <div class="top-selling-slider product-arrow">
                            <div>
                                <img class="special-offer-img"
                                    src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/webp_original/pink-fashion-products-end-of-season-advertisement-template-y33vjq09df8915.webp"
                                    class="blur-up lazyload" alt="">
                            </div>

                            <div>
                                <img class="special-offer-img"
                                    src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/webp_original/stationery-materials-ads-template-02p08f383ed3fb.webp"
                                    class="blur-up lazyload" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="slider-5_2 img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/1.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/2.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/3.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/4.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/5.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/6.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/7.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/8.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="../assets/images/grocery/deal/9.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
