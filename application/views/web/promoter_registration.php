            ...
            <div class="col-xxl-8 col-xl-9 col-lg-10 col-sm-12">
                <div class="log-in-box p-4 shadow-sm rounded">
                    ...
                    <div class="log-in-title text-center mb-4">
                        ...
                        <h4>Register as Promoter</h4>
                    </div>

                    <form class="row g-3" id="promoter_registration_form" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Vendor Logo -->
                        <div class="col-md-6">
                            <label class="form-label">Shop / Promoter Logo</label>
                            <input type="file" class="form-control" name="promoter_logo" accept="image/*">
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label">
                                    By registering, I confirm that I agree to the
...
<script>
    $('#promoter_registration_form').on('submit', function (e) {
        e.preventDefault();

        var formData = new FormData(this);

        $.ajax({
            url: "<?= site_url('admin/Vendor/promoter_registration'); ?>",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            ...
            success: function (res) {
                ...
                if (res.status == 'success') {
                    ...
                    $('#promoter_registration_form')[0].reset();
                } else {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
...
<script>
    $(document).ready(function () {
        ...
        $('#verify_email_btn').click(function () {
            ...
            $.post('<?= base_url("admin/Vendor/promoter_send_email_otp") ?>', { email: email }, function (res) {
                res = JSON.parse(res);
                $('#loader').fadeOut(50);
        ...
        $('#verify_otp_btn').click(function () {
            ...
            $.post('<?= base_url("admin/Vendor/promoter_verify_email_otp") ?>', { email: email, otp: otp }, function (res) {
                res = JSON.parse(res);
                $('#loader').fadeOut(50);
