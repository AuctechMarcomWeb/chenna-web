<script type="text/javascript">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage Units  <a href="<?php echo base_url('admin/Dashboard/addUnit/');?>" class="btn btn-info" style="float: right; padding-right: 10px; ">Add Unit</a> 
      </h1>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="padding-left: 50px "><a href="<?php echo site_url().'admin/Dashboard/UpdateUnit/'.$value['id']?>"><?php echo $value['unit_name']?></a></td>
                  <td>
                  ...
                  <td>
                    <a href="<?= base_url('admin/Dashboard/UpdateUnit/'.$value['id']); ?>" class="btn btn-info"> Edit </a>
                  </td>
