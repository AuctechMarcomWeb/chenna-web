              ...
              <div class="row" style="margin-top: 6px;">
                ...
                <div class="col-sm-3">
                  ...
                  <select class="form-control" name="order_status">
                    ...
                    <option value="2" <?php echo (@$_POST['order_status'] == '2') ? 'Selected' : '' ?>>
                      Order&nbsp;cancel&nbsp;by customer</option>
                    <option value="3" <?php echo (@$_POST['order_status'] == '3') ? 'Selected' : '' ?>>
                      Order&nbsp;confirmed&nbsp;by seller</option>
                    <option value="2" <?php echo (@$_POST['order_status'] == '2') ? 'Selected' : '' ?>>
                      Order&nbsp;reject&nbsp;by seller</option>
                    <option value="4" <?php echo (@$_POST['order_status'] == '4') ? 'Selected' : '' ?>>Order&nbsp;Shipped
                    </option>
                    <option value="5" <?php echo (@$_POST['order_status'] == '5') ? 'Selected' : '' ?>>
                      Order&nbsp;Delivered</option>
                    <option value="6" <?php echo (@$_POST['order_status'] == '6') ? 'Selected' : '' ?>>Return&nbsp;Request
                    </option>
                ...
                <div class="col-sm-2">
                  ...
                  <input type="text" class="form-control" name="keywords" placeholder="Enter Order Number"
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      $statusArr = [
                        ...
                        2 => '<b style="color:#ff6c00">Order&nbsp;cancel&nbsp;by customer</b>',
                        3 => '<b style="color:green">Order&nbsp;confirmed&nbsp;by seller</b>',
                        2 => '<b style="color:red">Order cancel by customer</b>',
                        4 => '<b style="color:#ff6c00">Order&nbsp;Shipped</b>',
                        5 => '<b style="color:green">Order&nbsp;Delivered</b>',
                        6 => '<b style="color:#ff6c00">Return Request</b>',
                    ...
                    <td>
                      ...
                      <a href="<?= site_url('admin/Order/ViewOrder/' . $order['id'] . '/' . $order['payment_type']); ?>"
