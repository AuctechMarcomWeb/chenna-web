             ...
             <div class="table-responsive"> 
              <table id="example1111" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <?php 
                        if( $value['status']==1){ echo '<b style="color:#ff6c00">Order&nbsp;waiting&nbsp;for&nbsp; seller&nbsp;approval</b>';}
                        if($value['status']==4){ echo '<b style="color:#f00">Order&nbsp;cancel&nbsp;by customer</b>';}
                        if($value['status']==5){ echo '<b style="color:#ff6c00">Order&nbsp;confirmed&nbsp;by seller</b>';}
                        if($value['status']==6){ echo '<b style="color:green">Order&nbsp;reject&nbsp;by seller</b>';}
                        if($value['status']==3){ echo '<b style="color:green">Order&nbsp;Delivered</b>';}
                        if($value['status']==2){ echo '<b style="color:#ff6c00">Order&nbsp;shipped</b>';}
                        if($value['status']==7){ echo '<b style="color:#ff6c00">Return&nbsp;Request</b>';}
                        if($value['status']==8){ echo '<b style="color:green">Return&nbsp;Completed</b>';
                    }?>
                 ...
                 <!--  <td>
                  ...
                  <td>
                    <a href="<?php echo site_url().'admin/Order/ViewOrder/'.$value['id']?>"><button class="btn btn-info">View</button></a>
                 ...
                 <!--  <td> 
                  ...
                  <!--<td><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;<?php //echo $order['final_price']+ $order['shippment_charge']+ $order['gst'];?></td>-->
