    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="col-sm-4">
          <div class="box box-solid">
            <div class="box-body" style="height: 220px;">
              <h4 class="box-header with-border"><b>Customer Informationnnn</b> <i class="fa fa-address-card-o"
        ...
        <div class="col-sm-4">
          <div class="box box-solid">
            <div class="box-body" style="height: 220px;">
              <h4 class="box-header with-border"><b>Shipping Information</b> <i class="fa fa-address-card-o"
                  aria-hidden="true"></i></h4>
              <?php

              $address_data = $this->db->get_where('order_address_master', array('order_master_id' => $getData['id']))->row_array();
              ?>
              <h4 class="box-header" style="margin-top: -15px;"><?php echo ucwords(@$address_data['title']) ?> -
                <?php echo ucwords(@$address_data['contact_person']) ?></h4>

              <div style="margin-left: 15px;margin-top: -6px;">
                <p style="font-size: 15px ">
                  <?php echo @$address_data['address'] . ", " . @$address_data['localty'] . ", " . @$address_data['landmark'] . "<br>" . @$address_data['city'] . " - " . @$address_data['state'] . "<br> Pincode - " . @$address_data['pincode'] . ".<br><b>Phone -" . @$address_data['mobile_number'] . "</b>"; ?>
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table class="table">
                  <tbody>
                    ...
                    <tr
                      style="border-top-style:outset; border-top-width:2px;border-top-color:#d4d4ca; border-bottom-style:outset; border-bottom-width:2px;border-bottom-color:#d4d4ca;">
