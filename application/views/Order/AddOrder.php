      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal"  action="<?php echo site_url('admin/Vendor/AddVendorData/');?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
            <!--   <div class="col-md-12" style="text-align: center; background-color: #eee  ">

              <h3 style="padding-bottom: 25px;">Vendor Informations</h3>
              </div> -->
                <div class="form-group">
                   <label for="inputEmail3" class="col-sm-2 control-label"> Full Name <span style="color: red">*</span></label>
                  <div class="col-sm-10">
                    
                    <input type="text" class="form-control" name="VendorName" required placeholder="Full Name">
                  </div>
                ...
                <label for="inputEmail3" class="col-sm-2 control-label"> Username <span style="color: red">*</span></label>
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" name="VendorUserName" required placeholder="Username">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="email" class="form-control" name="VendorEmail" required placeholder="Email">
                  </div>
                ...
                <label for="inputEmail3" class="col-sm-2 control-label"> Contact No. <span style="color: red">*</span></label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="VendorCntct" onchange="ContactnumberCheck(this.value)" required placeholder="Contact Number">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   <input type="file" class="form-control" name="uploadFileVendor" >
                  </div>
                </div>
