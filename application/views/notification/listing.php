          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php /*  <td><?php if( $value['image']!=""){ ?><img src="<?php echo base_url('assets/notification_images').'/'.$value['image'];?>" width="80px" height="80px"><?php } else { ?> <img src="<?php echo base_url('assets/default.jpg');?>" width="120px" height="80px" > <?php } ?></td> */ ?>
                  ...
                  <td>
                    ...
                    <?php if( $value['image']!=""){ ?>
                   <a href="<?php echo base_url('admin/Notification/View')."/".$value['id'] ?>" class="btn btn-info"><i class="fa fa-file-image-o" aria-hidden="true"></i></a>
                   <?php } ?>
