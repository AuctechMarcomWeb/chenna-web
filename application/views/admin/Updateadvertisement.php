            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="POST"
                        action="<?= base_url('admin/Dashboard/update_advertisement'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <select name="img_section" class="form-control" required>
                                    ...
                                    <option value="fixed" <?= ($banner->img_section == 'fixed') ? 'selected' : ''; ?>>Fixed
                                        Image</option>
                                    <option value="bottom" <?= ($banner->img_section == 'bottom') ? 'selected' : ''; ?>>Bottom
                                        Image</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                { ?>
                                    <br>
                                    <img src="<?= base_url('uploads/advertisement/' . $banner->image); ?>" height="60">
