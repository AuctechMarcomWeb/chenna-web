...
<head>
    ...
    <title>Chenna | Log in</title>
    <!-- Tell the browser to be responsive to screen width -->
    <link rel="shortcut icon" href="<?php echo site_url('/plugins/images/logo.png'); ?>" type="image/x-icon">
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="<?php echo site_url('assets/images/android-icon-36x36.png'); ?>">
    <!-- Theme style -->
    ...
    <style type="text/css">
    body {
        background-image: url("<?php echo site_url('/plugins/images/admin-bg.jpg'); ?>");
        display: flex;
        align-items: center;
    ...
    .login-page2 {
        background-image: url(<?php echo base_url('/assets/admin.jpg');
        ?>) !important;
    ...
    .login-page1 {
        ...
        background-image: url(<?php echo base_url('/assets/admin.png');
        ?>) !important;
    ...
    <div class="login-box">
        <div class="login-box-body">
            <div class="login-logo">
                <img src="<?php echo site_url('/plugins/images/logo.png'); ?>" style="max-width:170px;"> <br>

            </div>
            <p class="login-box-msg">Sign in to Chenna</p>
                ...
                <form name="registration" id="registration" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-8">
                            ...
                            <input type="text" class="form-control pull-right" name="Femail" id="Femail"
                                placeholder="Enter Email-id">
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="button" onclick="ForgetPassword()" class="btn btn-info pull-right" id="updateBtn">
                        </button>
        ...
        if (check == true) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response > 0) {
                        $("#hiddenSms2").html(
                            "<b style='color:green; text-align:center;'>Password is sent to your Email id</b>"
                        );
