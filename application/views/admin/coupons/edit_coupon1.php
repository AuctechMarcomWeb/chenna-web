...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
                <?php echo form_open_multipart('admin/ManageCoupon/editCoupon/'.base64_encode($c_id), array('class'=>'forms-sample','id'=>'editCoupon')); ?>
                  <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="input-group-addon">
                                 ...
                                 <select class="form-control" name="offer_type" id="offer_type" aria-label="" aria-describedby="basic-addon1">
                                    <option value="checkout" <?php if(!empty($coupons['offer_type'])){if($coupons['offer_type']=='checkout'){echo 'selected';}} ?>>Checkout</option>
                                    <option value="wallet" <?php if(!empty($coupons['offer_type'])){if($coupons['offer_type']=='wallet'){echo 'selected';}} ?>>Wallet</option>
                                   </select>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="input-group-addon">
                                 ...
                                 <select class="form-control" name="apply_discount" id="coupon_type" aria-label="" aria-describedby="basic-addon1" onchange="apply_discount_field(this.value)">
                                    ...
                                    <option value="1" <?php if(!empty($coupons['apply_discount'])){if($coupons['apply_discount']=='1'){echo 'selected';}} ?>>Over All</option>

                                    <option value="2" <?php if(!empty($coupons['apply_discount'])){if($coupons['apply_discount']=='2'){echo 'selected';}} ?>>Category</option>

                                    <option value="3" <?php if(!empty($coupons['apply_discount'])){if($coupons['apply_discount']=='3'){echo 'selected';}} ?>>Sub Category</option>

                                    <option value="4" <?php if(!empty($coupons['apply_discount'])){if($coupons['apply_discount']=='4'){echo 'selected';}} ?>>Customer</option>

                                    <option value="5" <?php if(!empty($coupons['apply_discount'])){if($coupons['apply_discount']=='5'){echo 'selected';}} ?>>Product</option>

                                   </select>
                                </div>
                                <input type="hidden" id="apply_discount" value="<?= $coupons['apply_discount'] ?>">
                                <span class="input_err" id="err_coupon_type"></span>
                             </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-12 hide" id="cat_tab">
                            <div class="form-group" data-select2-id="13">
                              ...
                              <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select Category" style="width: 100%;" data-select2-id="7" tabindex="-1" aria-hidden="true" name="apply_coupon[]">
                                <?php
                                // $cat = json_decode($cat['category_name'],true);
                                $category = json_decode($coupons['apply_coupon'],true);
                                if(!empty($catData)){
                                  $selected='';
                          ...
                          <div class="col-md-12 hide" id="sub_cat_tab">
                              <div class="form-group" data-select2-id="13">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select Sub-Category" style="width: 100%;" data-select2-id="7" tabindex="-1" aria-hidden="true" name="apply_coupon[]">
                                  <?php 
                                  $subcategory = array();
                                  $subcategory = json_decode($coupons['apply_coupon'],true);
                                  if(!empty($subCatData)){
                                  $selected='';

                                  foreach ($subCatData as $subcat) { 
                                  if(in_array($subcat['id'], $subcategory)){
                                  $selected='selected'; 
                                  }else{
                                  $selected=''; 
                                  }
                                    ?>
                                  <option <?= $selected; ?> value="<?= $subcat['id']; ?>"><?= $subcat['sub_category_name']; ?></option>
                                  <?php } }?>
                                </select>
                              </div>
                           </div> 
                          ...
                          <div class="col-md-12 hide" id="customer_tab">
                                <div class="form-group" data-select2-id="13">
                                  ...
                                  <?php 
                                  $customer = json_decode($coupons['apply_coupon'],true);
                                  if(!empty($userData)){
                                  $selected='';
                                  foreach ($userData as $custData) { 
                                  if(in_array($custData['id'], $customer)){
                                  $selected='selected'; 
                                  }else{
                                  $selected=''; 
                                  }
                                  ?>
                                 <option <?= $selected; ?> value="<?= $custData['id']; ?>">
                                  <?= $custData['username']; ?> 
                                 </option>
                                 <?php } }?>
                                 </select>
                            ...
                            <div class="col-md-12 hide" id="product_tab">
                                  <div class="form-group" data-select2-id="13">
                                    ...
                                    <?php 
                                    $product = json_decode($coupons['apply_coupon'],true);
                                    if(!empty($proData)){
                                    $selected='';
                                    foreach ($proData as $pro_data) { 
                                    if( in_array($pro_data['id'], $product)){
                                    $selected='selected'; 
                                    }else{
                                    $selected=''; 
                                 }
                                      ?>  
                                    <option <?= $selected; ?> value="<?= $pro_data['id']; ?>"><?= $pro_data['product_name']; ?>&nbsp; -  &nbsp;<?= $pro_data['sku_code']; ?></option>
                                    <?php } }?>
                                    </select>
                                  </div>
                               </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group-addon">
                                         ...
                                         <select class="form-control" name="applicable_payment_mode" id="applicable_payment_mode" aria-label="" aria-describedby="basic-addon1">
                                            ...
                                            <option value="cod" <?php if(!empty($coupons['applicable_payment_mode'])){if($coupons['applicable_payment_mode']=='cod'){echo 'selected';}} ?>>Cod</option>

                                            <option value="online" <?php if(!empty($coupons['applicable_payment_mode'])){if($coupons['applicable_payment_mode']=='online'){echo 'selected';}} ?>>Prepaid</option>
                                           </select>
                                        </div>
                                        <span class="input_err" id="err_coupon_type"></span>
                                        </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group row remove_mb">
                                      ...
                                      <div class="col-sm-12">
                                          <input type="text" class="form-control" name="max_total_usage" id="max_total_usage" placeholder="Max Total Usage" autocomplete="off" value="<?= @$coupons['max_total_usage']; ?>"/>
                      ...
                      <div class="row remove_height">
                              ...
                              <div class="col-sm-12"> 
                                 ...
                                 <div class="input-group">
                                  ...
                                  <select class="form-control" name="coupon_discount_type" id="payment_factor" aria-label="" aria-describedby="basic-addon1">
                                      <option value="1" <?php if (@$coupons['coupon_discount_type'] == 1) { echo "selected"; }?>>Flat</option>
                                      <option value="2" <?php if (@$coupons['coupon_discount_type'] == 2) { echo "selected"; }?>>Percentage</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row remove_mb">
                              ...
                              <div class="col-sm-12">
                                  <select class="form-control" name="coupon_type" id="coupon_category">

                                      <option value="1" <?php if(!empty($coupons['coupon_type'])){if($coupons['coupon_type']=='1'){echo 'selected';}} ?>>Discount</option>

                                    <option value="2" <?php if(!empty($coupons['coupon_type'])){if($coupons['coupon_type']=='2'){echo 'selected';}} ?>>Cashback</option>
                      ...
                      <!--   <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                            <div class="form-group row remove_mb">
                             ...
                             <div class="input-group">
                                <div class="input-group-addon">
                                 <button class="btn btn-outline-secondary addon_btn" type="button"><i class="fa fa-asterisk" aria-hidden="true"></i>  
                                 </button>
                                </div>
                                  <input type="number" class="form-control" name="value_amt" id="value_amt" placeholder="Coupon Discount Value" value="<?= @$coupons['coupn_discount_val']; ?>" oninput="checkminval(this.value);" autocomplete="off"/>
                             </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row remove_mb">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" value="<?= @$coupons['min_dis_val']; ?>" name="min_dis_val" id="max_total_usage" placeholder="Enter Product Price Range" autocomplete="off"/>
                                <span class="input_err" id="err_title"></span>
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="col-md-6">
                          <div class="form-group row remove_mb">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" value="<?= @$coupons['product_price_range']; ?>" name="product_price_range" id="max_total_usage" placeholder="Enter Product Price Range" autocomplete="off"/>
                                <span class="input_err" id="err_title"></span>
                            </div>
                          </div>
                        </div>
                       ...
                       <!--  <div class="col-md-6">
                            <div class="form-group row remove_mb">
                              <label class="col-sm-12 col-form-label">Coupon Discount Value <span class="star_red">*</span></label>
                              <div class="col-sm-12">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                 <button class="btn btn-outline-secondary addon_btn" type="button"><?= PRICE1 ?> </button>
                                  ...
                                  <input type="number" class="form-control" name="value_amt" id="value_amt" placeholder="Coupon Discount Value" autocomplete="off" value="<?= @$coupons['discount_value']; ?>" oninput="checkminval(this.value);" />
                                </div>
                                  <span class="input_err" id="err_value_amt"></span>
                              </div>
                            </div>
                              ...
                              <div class="col-sm-12">
                                ...
                                <div class="input-group-addon">
                                 <button class="btn btn-outline-secondary addon_btn" type="button"><?= PRICE1 ?></button>
                                  ...
                                  <input type="number" class="form-control" name="min_amt" id="min_amt" placeholder="Minimum Amount" value="<?= @$coupons['minimum_applicable_amount']; ?>" oninput="checkminval();" autocomplete="off"/>
                                </div>
                              ...
                              <div class="input-group">
                                <div class="input-group-addon">
                                  <button class="btn btn-outline-secondary addon_btn" type="button"><i class="fa fa-calendar" aria-hidden="true"></i></button>
                                   ...
                                   <input type="text" class="form-control sel_date" name="start_date" id="start_date" value="<?= date('m/d/Y', $coupons['start_date']); ?>" placeholder="Start Date" onchange="checkEndDate();" autocomplete="off"/>
                                </div>
                               ...
                               <div class="input-group">
                                <div class="input-group-addon">
                                  <button class="btn btn-outline-secondary addon_btn" type="button"><i class="fa fa-calendar" aria-hidden="true"></i></button>
                                   ...
                                   <input type="text" class="form-control sel_date" name="end_date" id="end_date" placeholder="End Date" onchange="checkEndDate();" autocomplete="off" value="<?= date('m/d/Y', $coupons['end_date']); ?>" />
                                </div>
                      ...
                      <div class="row remove_height">
                       ...
                       <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="coupon_message" rows="2" placeholder="Message to be displayed in the website"><?= @$coupons['coupon_message']; ?></textarea>
                          </div>
                        </div>
                      </div>
              ...
              <!--         <div class="row remove_height">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              <label>Coupon Details</label>
                              <textarea class="form-control" name="coupon_message" rows="3" placeholder="Message to be displayed in the website"><?= @$coupons['coupon_message']; ?></textarea>
                          </div>
                        </div>
                      ...
                      <br/><br/><button type="submit" class="btn btn-primary btn-fw" id="submitData" onclick="return checkminval();" style="float: right;">Update</button>
                  </div>
              <?= form_close(); ?>
        </div>
      </div>
...
$(document).on('keyup', '#coupon_code', function(e) {
  ...
  function checkminval(){
    ...
    value_amt = parseInt(value_amt);
     if(value_amt>minval){
        $('#err_min_amt').html('<span id="min_val_err">Product Minimum Amount is greater than to Coupon Discount Value.</span>');
...
$( document ).ready(function() {
var apply_discount_id = $('#apply_discount').val(); 
apply_discount_field(apply_discount_id);
});
...
$('#sub_cat_tab').empty().append('<option selected="selected" value=""></option>');
$('#customer_tab').empty().append('<option selected="selected" value=""></option>');
$('#product_tab').empty().append('<option selected="selected" value=""></option>');
...
$('#cat_tab').empty().append('<option selected="selected" value=""></option>');
$('#customer_tab').empty().append('<option selected="selected" value=""></option>');
$('#product_tab').empty().append('<option selected="selected" value=""></option>');
