...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
              <?php echo form_open_multipart('admin/ManageCoupon/addVoucher',array('class'=>'forms-sample','id'=>'addCategory')); ?>
                  <div class="card-body">
                      <div class="row remove_height"> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group row remove_mb">
                                  ...
                                  <div class="col-sm-12">
                                      <input type="text" class="form-control" name="voucher_code" id="voucher_code" placeholder="Enter Voucher Code" onkeyup="checkRequired('required',this.value,'voucher_code','');" autocomplete="off"/>
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon">
                                     <button class="btn btn-outline-secondary addon_btn" type="button"><?= PRICE1 ?></button>
                                      ...
                                      <input type="number" class="form-control" name="value_amt" id="value_amt" placeholder="Enter Max Discount Value" oninput="checkminval(this.value);" autocomplete="off"/>
                                    </div>
                            ...
                            <div class="col-md-6">
                                  ...
                                  <div class="col-sm-12">
                                    ...
                                    <div class="input-group-addon">
                                     <button class="btn btn-outline-secondary addon_btn" type="button"><?= PRICE1 ?></button>
                                      ...
                                      <input type="number" class="form-control" name="min_cart_value" id="min_amt" placeholder="Minimum Amount In Cart" oninput="checkminval();" autocomplete="off"/>
                                    </div>
                               ...
                               <div class="col-md-6">
                                <div class="form-group row remove_mb">
                                  ...
                                  <div class="col-sm-12">
                                      <input type="text" class="form-control" name="no_of_uses" id="no_of_uses" placeholder="No of Voucher Uses" autocomplete="off" required/>
                                  </div>
                                </div>
                            </div>
                          </div>
