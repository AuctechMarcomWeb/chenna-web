...
<div class="login-box">
  ...
  <div class="login-logo">
   <img src="<?php echo site_url().'assets/logo.png' ?>" style="max-width:224px;"> <br/> Seller Login
  </div>
  ...
  <?php echo $this->session->flashdata('login_message'); ?>
   ...
   <form method="post" action="<?php echo site_url().'admin/welcome/sellerLogin'; ?>">
      ...
      <div class="form-group has-feedback">
        <input type="number" name="mobile" class="form-control" placeholder="Mobile" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "10">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label><a href="<?php echo base_url();?>admin/welcome/forgot_pass" class="text-center"><i class="fa fa-lock" style="font-size:20px"></i>&nbsp;&nbsp;&nbsp;Forgot Password?</a></label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
