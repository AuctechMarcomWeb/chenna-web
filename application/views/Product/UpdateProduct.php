      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            $colorRow = $this->db->get_where('tab_color_master', [
              ...
              foreach ($sizeArray as $sizeRow)
              {
                ...
                ?>
                                                  ...
                                                  <div class="row" style="margin-left: 10px;margin-top: 10px;">
                                                    ...
                                                    <div class="col-sm-2"> <input type="text" readonly  name="color[]" value="<?= htmlspecialchars($colorName); ?>" class="form-control"></div>
                  ...
                  <div class="row" style="margin-left:10px;"> 
                    ...
                    <br><br>
                     <div class="col-sm-12 p-2">
                      <label>Details</label>
                      <textarea class="form-control" name="pro_description" id="pro_description" placeholder="Product Description"><?= $getData['product_description']; ?></textarea>
                    </div> 
                  </div>
                  <hr>
