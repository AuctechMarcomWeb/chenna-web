              ...
              '';
               ...
               } else
               {
                ...
                } else
                {
                  ...
                  <form action="<?php echo base_url(); ?>admin/product/final_submit2/<?php echo $product_id; ?>" method="POST">
                    ...
                    <div class="row" style="margin-left: 10px;"> 
                      ...
                      <div class="col-sm-3">
                       <label>Occasion</label>
                        <input type="text" class="form-control"  name="occasion" placeholder="Occasion" value="<?= $getData['occasion']; ?>">
                      </div>
                      <div class="col-sm-3">
                       <label>Fit </label>
                        <input type="text" class="form-control" name="fit" placeholder="Fit" value="<?= $getData['fit']; ?>">
                      </div>
                      <div class="col-sm-3">
                       <label>Fabric</label>
                      ...
                      <div class="col-sm-3">
                       <label>Length</label>
                        <input type="text" class="form-control"  name="length" placeholder="Length" value="<?= $getData['length']; ?>">
                      </div> 
                      <div class="col-sm-3">
                       <label>Ideal For</label>
                        <input type="text" class="form-control"  name="ideal_for" placeholder="Ideal For" value="<?= $getData['ideal_for']; ?>">
                      </div>
                      <div class="col-sm-3">
