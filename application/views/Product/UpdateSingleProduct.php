             ...
             <div class="box-body">
               ...
               <div class="row" style="margin-left: 10px;">
                 <div class="col-sm-3">
                   ...
                   <select class="form-control select2" name="shop_id" id="shop_id" required placeholder="Select Category">
                     ...
                     <?php foreach ($shopList as $shopList) { ?>
                       <option value="<?php echo $shopList['id'] ?>" <?= ($shopList['id'] == $getData['shop_id']) ? 'selected' : '' ?>><?php echo ucfirst($shopList['name']) ?></option>
                     <?php } ?>
                   </select>
                 </div>
                 ...
                 <div class="col-sm-3">
                   ...
                   <select class="form-control select2" name="category_id" id="cat_master_ID" required placeholder="Select Category">
                     <option value="">Select Category</option>
                     <?php foreach ($getCatgy as $allCatgy) { ?>
                       <option value="<?php echo $allCatgy['id'] ?>" <?= ($allCatgy['id'] == $getData['category_id']) ? 'selected' : '' ?>><?php echo ucfirst($allCatgy['category_name']) ?></option>
                     <?php } ?>
                   </select>
                 </div>
                 ...
                 <div class="col-sm-4">
                   ...
                   <input type="text" class="form-control" value="<?= $getData['product_name']; ?>" name="ProductName" placeholder=" Product Name" required>
                 </div>

                 <div class="col-sm-2">
                   <label>SKU Code<span class="err_color">*</span></label>

                   <input type="text" class="form-control" value="<?= $getData['sku_code']; ?>" name="sku_code" placeholder="SKU Code">
                 </div>
               ...
               <div id="AllDiv">
                 <div class="row" style="margin-left: 10px;">
                   <div class="col-sm-3">
                     ...
                     <input type="number" value="<?= $getData['price']; ?>" class="form-control" name="prod_price" id="price" placeholder=" Price" required>
                   </div>


                   <div class="col-sm-3">
                     <label>Final Price(<?= PRICE1 ?>)<span class="err_color">*</span></label>
                     <input type="number" value="<?= $getData['final_price']; ?>" class="form-control" name="finalPrice" placeholder=" Final Price">
                   </div>

                   <div class="col-sm-3">
                     <label>Size <span class="err_color">*</span></label>
                     <input type="text" value="<?= $getData['size']; ?>" class=" form-control" required="" placeholder="Size">
                   </div>

                   <div class="col-sm-3">
                     <label>Quantity <span class="err_color">*</span></label>
                     <input type="number" value="<?= $getData['quantity']; ?>" class="form-control" min="0" name="qty" id="qty" placeholder="Quantity" required>
                   </div>
 ...
 <script>
   ...
   function GetGstVal(data) {
     var a = (data.value);
     $("#msg").load('<?php echo base_url('admin/Product/action2'); ?>', {
       "subCatId": a
     });
   }
