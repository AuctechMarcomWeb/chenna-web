            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                  ...
                  <form action="<?php echo base_url(); ?>admin/product/save_general_info" method="POST">
                    <div class="row" style="margin-left: 10px;">
                      ...
                      <div class="form-group col-sm-4">
                        ...
                        <select id="par_cat_master_ID" name="par_cat_master_ID" class="form-control select2" required
                          style="width:100%;">
                          <option value="">Select Parent Category</option>
                          <?php foreach ($getParCatgy as $parent): ?>
                            <option value="<?= $parent['id']; ?>" <?= ($parent['id'] == @$getBasicInfo['mai_id']) ? 'selected' : '' ?>>
                              <?= ucfirst($parent['name']); ?>
                            </option>
                          <?php endforeach; ?>
                        </select>
                      ...
                      <div class="form-group col-sm-4">
                        ...
                        <select id="cat_master_ID" name="cat_master_ID" class="form-control select2" required
                          style="width:100%;">
                    ...
                    <div class="row" style="margin-left: 10px;">
                      ...
                      <div class="form-group col-sm-4">
                        ...
                        <select id="sub_master_ID" name="sub_master_ID" class="form-control select2" required
                          style="width:100%;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" name="ProductName" id="ProductName"
                          placeholder="Product Name" value="<?= @$getBasicInfo['product_name']; ?>" required>
                      </div>
                      <div class="col-sm-4">
                    ...
                    <div class="row" style="margin-left: 10px;">
                      ...
                      <textarea class="form-control" cols="5" rows="5" name="product_description"
                        required=""><?= @$getBasicInfo['product_description']; ?></textarea>
                ...
                } else
                {
                  ...
                  <form action="<?php echo base_url(); ?>admin/product/save_color_size" method="POST">
                    <div id="product_html">
                        ...
                        foreach ($getSizeColor as $key => $getColorData)
                        {
                          ...
                          <div class="row" style="margin-left: 10px;">
                            <div class="col-sm-4">
                              ...
                              <input type="text" value="<?= $getColorData['color']; ?>" class="form-control" name="color[]"
                                placeholder="Color" required>
                            </div>

                            <div class="col-sm-4">
                              <label>Size <span class="err_color">*</span></label>
                              <select class="form-control select2" id="related_size1" multiple name="size0[]"
                                ...
                                <!-- Kids -->
                                <option value="1 – 1.5 years" <?php if (in_array('1 – 1.5 years', $size_array))
                                  echo 'selected'; ?>>1 – 1.5 years</option>
                                <option value="2 – 2.5 years" <?php if (in_array('2 – 2.5 years', $size_array))
                                  echo 'selected'; ?>>2 – 2.5 years</option>
                                <option value="3 – 3.5 years" <?php if (in_array('3 – 3.5 years', $size_array))
                                  echo 'selected'; ?>>3 – 3.5 years</option>
                                <option value="4 – 4.5 years" <?php if (in_array('4 – 4.5 years', $size_array))
                                  echo 'selected'; ?>>4 – 4.5 years</option>
                                <option value="5 – 5.5 years" <?php if (in_array('5 – 5.5 years', $size_array))
                                  echo 'selected'; ?>>5 – 5.5 years</option>
                                <option value="6 – 7 years" <?php if (in_array('6 – 7 years', $size_array))
                                  echo 'selected'; ?>>6 – 7 years</option>
                                <option value="8 – 9 years" <?php if (in_array('8 – 9 years', $size_array))
                                  echo 'selected'; ?>>8 – 9 years</option>
                                <option value="10 – 11 years" <?php if (in_array('10 – 11 years', $size_array))
                                  echo 'selected'; ?>>10 – 11 years</option>
                                <option value="12 – 13 years" <?php if (in_array('12 – 13 years', $size_array))
                                  echo 'selected'; ?>>12 – 13 years</option>
                      ...
                      <div id="add_more_1">
                        <div class="row" style="margin-left: 10px;">
                          <button type="button" class="btn btn-info pull-right" onclick="addMoreProduct(2);">Add
                            More</button>
                        </div>
                      </div><br>
                    </div>
                  ...
                  <form action="<?php echo base_url(); ?>admin/product/color_size" method="POST">
                    ...
                    <?php foreach ($sizeArray as $key => $sizeArray)
                    {
                      ...
                      <div class="row" style="margin-left: 10px;margin-top: 10px;">
                        ...
                        <div class="col-sm-2"><input type="text" readonly="" name="size[]"
                            value="<?= @$sizeArray['size']; ?>" class="form-control"></div>
                        <div class="col-sm-2"><input type="text" class="form-control"
                            value="<?= @$price['final_price']; ?>" name="sp[]" placeholder="S.P" required=""></div>
                        <div class="col-sm-2"><input type="text" class="form-control" value="<?= @$price['price']; ?>"
                            name="mrp[]" placeholder="M.R.P" required=""></div>
                        <div class="col-sm-2"><input type="text" class="form-control" value="<?= @$price['qty']; ?>"
                            name="qty[]" placeholder="Quantity" required=""></div>
                ...
                } else
                {
                  ...
                  <form action="<?php echo base_url(); ?>admin/product/color_size_images" method="POST"
                ...
                <div class="<?php if ($tab_id == '6')
                {
                  ...
                  <form action="<?php echo base_url(); ?>admin/product/final_submit" method="POST" id="productForm">
                    ...
                    <hr>
                    <!-- Container jahan cloned fields add honge -->
