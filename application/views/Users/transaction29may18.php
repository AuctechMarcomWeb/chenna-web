...
<script type="text/javascript">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="text-center"><h3>Total Wallet Amount : <?php echo singlerowparameter2('wallet_amount','id',$this->uri->segment('4'),'user_master') ?> /-</h3></div>
    </section>
...
<!-- <td><?php //if($value['type'] == 3){ //echo 'Wallet'; } else{ echo 'Real Money';} ?></td> -->
   <!--               <td>
                   <?php /*if($value['status'] == 1){
                     echo"<b style='color:maroon'>Pending</b>";
