      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <!-- form start -->
            <form class="form-horizontal"  action="<?php echo site_url('admin/School/AddClassBranch/')."/".$adminData['Id'];?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control"  name="class_no" id="inputEmail3" placeholder="Class" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control"  name="section[]" id="inputEmail3" placeholder="Section " required>
                  </div>
                </div>
