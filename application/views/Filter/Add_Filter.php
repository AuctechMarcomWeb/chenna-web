     ...
     <div class="row">
       ...
       <div class="col-md-12">
         ...
         <div class="box box-info">
           <form class="form-horizontal"  action="<?php echo site_url('admin/Dashboard/AddFilterData/');?>" method="POST" enctype="multipart/form-data">
             <div class="box-body">
                  ...
                  <div class="col-sm-10">
                        <select class="form-control" name="subCatgy" id="subCatgy">
                          ...
                          <?php foreach ($SubCat as $allCatgy) {?>
                            <option value="<?php echo $allCatgy['id'] ?>"><?php echo ucfirst( $allCatgy['sub_category_name']) ?></option>
                            <?php } ?>
                        </select>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                        <select class="form-control" name="unit" id="unit">
                          ...
                          <?php foreach ($unit as $allCatgy) {?>
                            <option value="<?php echo $allCatgy['id'] ?>"><?php echo ucfirst( $allCatgy['unit_name']) ?></option>
                            <?php } ?>
                        </select>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                        <select class="form-control" name="dist" id="dist">
                          <option value ="">Select Distinguish</option>
                          <?php foreach ($Dist as $allCatgy) {?>
                            <option value="<?php echo $allCatgy['id'] ?>"><?php echo ucfirst( $allCatgy['distinguish_name']) ?></option>
                            <?php } ?>
                        </select>
                  </div>
                </div>
