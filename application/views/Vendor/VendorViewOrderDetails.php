                ...
                <form class="form-horizontal"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-10">
                      <?php if ($status == '3')
                      { ?>
                        <input type="text" class="form-control" required value="<?php echo ucwords('Order Delivered') ?>"
                          Disabled>
                      <?php } elseif ($status == '4')
                      { ?>
                      ...
                      <?php } elseif ($status == '7')
                      { ?>
                        <input type="text" class="form-control" required value="<?php echo ucwords('Return Request') ?>"
                          Disabled>
                      <?php } elseif ($status == '8')
                      { ?>
                        <input type="text" class="form-control" required value="<?php echo ucwords('Return Completed') ?>"
                          Disabled>
                      <?php } else
                      { ?>
                        <select name="StatusUpdate" style="color:black" class="form-control">
                          <option value="1" <?php echo ($status == '1') ? 'Selected' : '' ?>> Order waiting for seller
                            approval
                          </option>
                          <option value="5" <?php echo ($status == '5') ? 'Selected' : '' ?>> Order confirmed by seller
                          </option>
