  ...
  /*$this->Transaction_model->GetSingleData('school_master', 'id', 'school_name', $getFees['school_id']).'/'.$this->Transaction_model->GetSingleData('branch_master', 'id', 'school_address', $getFees['branch_id'])*/
                   ...
                   foreach ($result as $value) {
                    ...
                    if($getFees['fee_mode']== 4){ $fee = 'Monthly'; } 
                      $inst_month = $this->Transaction_model->GetInstallment($value['fee_mode'],$value['inst_month']);
                         echo '<tr>
                              <td>'.$count.'</td>
                              ...
                              <td>'.$fee.' ('.$inst_month.') </td>
                              
                              <td>  <i class="fa fa-inr" aria-hidden="true"></i> '.$value['wallet_used_amount'].'</td>
                              <td>  <i class="fa fa-inr" aria-hidden="true"></i> '.$value['payment_amount'].'</td>
