...
class GetWishList extends CI_Controller {
  ...
  public function index(){
    ...
    $check_request_keys = array( '0'  => 'user_id'
        ...
        if($resultJson > 0)
        {
        //   $this->Api_model->GetWishList($requestJson[APP_NAME]);
           $this->Api_model->GetWishList($requestJson);
