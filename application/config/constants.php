...
define('IMAGE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/auctech/Chenna-co/assets/category_images/');
...
define('PRODUCT_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/auctech/Chenna-co/assets/product_images/');
...
define('IMAGE_URL', 'https://'.$_SERVER['HTTP_HOST'].'/auctech/Chenna-co/assets/');
define('PROFILE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/auctech/Chenna-co/assets/profile_image/');
...
define('ABOUT_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/auctech/Chenna-co/assets/profile_image/');
define('REVIEW_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/auctech/Chenna-co/assets/customer_review_images/');
